...
export default function PetStoreCatSnackProductListPage() {
  const {
    productList,
    isLoading,
        ...
        <HeroBanner>
          <HeroInner>
            <HeroTextBox>
              ...
              <HeroTitle>
                맛있는 <strong>간식</strong>
              </HeroTitle>
              <HeroDesc>
                까다로운 입맛도 사로잡는 즐거운 한 입
                <br />
                우리 냥이 취향에 맞는 간식을 골라보세요.
              </HeroDesc>
            </HeroTextBox>

            <HeroImageBox>
              <HeroImageText>고양이 간식 배너 이미지 영역</HeroImageText>
            </HeroImageBox>
          </HeroInner>
        </HeroBanner>
                  ...
                  {productList.map((product, index) => {
                    ...
                    return (
                      <ProductCard key={product.productId}>
                        ...
                        <ProductCategoryBadge>간식</ProductCategoryBadge>
