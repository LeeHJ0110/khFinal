...
export default function PetStoreDogSupplementProductListPage() {
  ...
  const {
    ...
    handleChangeSort,
    handleChangeTagId,
  } = usePetStoreProductList("D", "SUPPLEMENT");
          ...
          <HeroInner>
            <HeroTextBox>
              ...
              <HeroDesc>
                ...
                <br />
                우리 아이의 매일을 더 든든하게 챙겨주세요.
              </HeroDesc>
            </HeroTextBox>

            <HeroImageBox>
              <HeroImageText>강아지 영양제 배너 이미지 영역</HeroImageText>
            </HeroImageBox>
          </HeroInner>
        </HeroBanner>
