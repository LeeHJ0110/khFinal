...
export default function PetStoreCatSupplementProductListPage() {
  const {
    productList,
    isLoading,
    ...
    handleChangeSort,
    handleChangeTagId,
  } = usePetStoreProductList("C", "SUPPLEMENT");
        ...
        <HeroBanner>
          <HeroInner>
            <HeroTextBox>
              ...
              <HeroTitle>
                건강한 <strong>영양제</strong>
              </HeroTitle>
              <HeroDesc>
                관절, 소화, 면역, 눈 건강까지 필요한 관리만 골라서
                <br />
                우리 냥이의 매일을 더 든든하게 챙겨주세요.
              </HeroDesc>
            </HeroTextBox>

            <HeroImageBox>
              <HeroImageText>고양이 영양제 배너 이미지 영역</HeroImageText>
            </HeroImageBox>
          </HeroInner>
        </HeroBanner>
                  ...
                  {productList.map((product, index) => {
                    ...
                    return (
                      <ProductCard key={product.productId}>
                        ...
                        <ProductCategoryBadge>영양제</ProductCategoryBadge>
