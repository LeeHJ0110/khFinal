...
import catStoreBanner from "../../assets/images/petStore/고양이홈배너.png";
...
import catToiletCard from "../../assets/images/petStore/모래카드.png";
...
export default function PetStoreCatHomePage() {
  ...
  return (
    <>
      ...
      <Wrapper>
        <HeroBanner>
          <HeroBannerImage src={catStoreBanner} alt="고양이 스토어 배너" />
